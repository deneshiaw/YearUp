...
public class FileIO 
{
	public static void main(String[] args) 
	{
		try
		{
		String filePath = "C:\\Users\\dwalton01116\\Documents\\OOP_week15.txt";
		...
		{
			System.out.println("There was a problem finding your file");
			ex1.printStackTrace();
		}
		catch (NullPointerException ex2)
		{
			System.out.println("There is no path present");
			ex2.printStackTrace();
		}
	}
